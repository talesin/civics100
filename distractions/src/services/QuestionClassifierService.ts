...
export const classifyQuestion = (question: Question): QuestionType => {
...
export const TestQuestionClassifierServiceLayer = (fn?: {
  classifyQuestion?: (question: Question) => QuestionType
}) =>
  Layer.succeed(
    QuestionClassifierService,
    QuestionClassifierService.of({
      _tag: 'QuestionClassifierService',
      classifyQuestion: fn?.classifyQuestion ?? (() => 'abstract')
    })
  )
