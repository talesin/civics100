...
import { QuestionSortField } from '../types'
...
import {
  ...
  getProbabilityLevel,
  truncateText
} from './QuestionStatisticsTable.shared'
...
const QuestionStatisticsTable = ({
  ...
  const handleSortKeyDown = useCallback(
    (field: QuestionSortField) => (event: React.KeyboardEvent) => {
        ...
        <thead style={theadStyles}>
          <tr>
            <th
              ...
              role="columnheader"
              aria-sort={
                sortField === QuestionSortField.QuestionNumber
                  ? sortAscending
                    ? 'ascending'
                    : 'descending'
                  : 'none'
            ...
            <th scope="col" style={thBaseStyles}>
              Question
            </th>
            ...
            <th
              ...
              role="columnheader"
              aria-sort={
                sortField === QuestionSortField.TimesAsked
                  ? sortAscending
                    ? 'ascending'
                    : 'descending'
                  : 'none'
            ...
            <th
              ...
              role="columnheader"
              aria-sort={
                sortField === QuestionSortField.Accuracy
                  ? sortAscending
                    ? 'ascending'
                    : 'descending'
                  : 'none'
            ...
            <th
              ...
              role="columnheader"
              aria-sort={
                sortField === QuestionSortField.Probability
                  ? sortAscending
                    ? 'ascending'
                    : 'descending'
                  : 'none'
