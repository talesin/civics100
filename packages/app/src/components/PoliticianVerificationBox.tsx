...
const PoliticianVerificationBox = ({
  ...
  const representative =
    selectedDistrict != null ? getRepresentativeForDistrict(selectedState, selectedDistrict) : null
  ...
  return (
    <VerificationBox>
      ...
      <PoliticianRow>
        ...
        {senators.length > 0 ? (
          senators.map((senator, index) => <PoliticianName key={index}>{senator}</PoliticianName>)
        ) : (
