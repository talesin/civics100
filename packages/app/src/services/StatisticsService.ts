 ...
 */
const calculateWeight = (pairedQuestionNumber: string, pairedAnswers: PairedAnswers): number => {
...
export const TestStatisticsServiceLayer = (fn?: {
  ...
  Layer.succeed(
    ...
    StatisticsService.of({
      ...
      calculateQuestionStatistics: fn?.calculateQuestionStatistics ?? (() => Effect.succeed([])),
