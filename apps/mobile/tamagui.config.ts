// Phase-1 copy of website/tamagui.config.ts — IDENTICAL tokens/themes/media.
// The ONLY difference vs the website file: the animation driver is imported from
// `./animations` (resolved to animations.web.ts / animations.native.ts per platform)
// instead of being created inline with `@tamagui/animations-css`.
// TEMPORARY: Phase 2 moves the canonical config into packages/app and re-points both
// website and apps/mobile at it. Keep this in sync until then.
