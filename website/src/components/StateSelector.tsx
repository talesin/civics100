...
export default function StateSelector({ selectedState, onStateChange, className = '' }: StateSelectorProps) {
  ...
  const detectLocation = async () => {
    ...
    try {
      ...
      if (typeof stateAbbr === 'string' && StatesByAbbreviation[stateAbbr as StateAbbreviation] !== undefined) {
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      <div className="flex items-center justify-between">
        ...
        {typeof navigator !== 'undefined' && typeof navigator.geolocation !== 'undefined' && hasLocationPermission !== false && (
          <button
